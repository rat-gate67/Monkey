...
```
```
=== RUN   TestFunctionApplication
--- PASS: TestFunctionApplication (0.00s)
PASS
ok      Monkey/evaluator        0.308s
```
これで基礎的なところは実装し終わった。
